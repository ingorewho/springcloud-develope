...
public class AspectService {
     ...
     * 前置:方法调用前执行
     */
    @Before("com.spring.aop.pointcut.PointCutService.point2()")
    public void before() {
    }
     ...
     * 后置:方法调用后执行，但还未退出方法
     */
    @After("com.spring.aop.pointcut.PointCutService.point3()")
    public void after() {
    }
     ...
     * 最终:退出方法后执行
     */
    @AfterReturning("com.spring.aop.pointcut.PointCutService.point4()")
     ...
     * 异常:发生异常时执行
     */
    @AfterThrowing("com.spring.aop.pointcut.PointCutService.point6()")
     ...
     */
    @Around("com.spring.aop.pointcut.PointCutService.point1()")
