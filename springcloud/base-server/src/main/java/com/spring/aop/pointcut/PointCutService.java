...
public class PointCutService {
    ...
    @Pointcut("@within(com.spring.aop.ClassAnnoation)")
    public void point3() {
     ...
     */
    @Pointcut("@annotation(com.spring.aop.LogOutput)")
    public void point4() {
     ...
     */
    @Pointcut("this(com.spring.aop.sevice.BaseBizService)")
    public void point6() {
     ...
     */
    @Pointcut("target(com.spring.aop.sevice.BaseBizService)")
    public void point7() {
